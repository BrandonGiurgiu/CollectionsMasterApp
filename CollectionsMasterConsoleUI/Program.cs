...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //TODO: Create a method to populate the number array with 50 random numbers that are between 0 and 50 (line 128)
            Populater(numbers);
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            {
                Console.WriteLine($"Yes, we have he number you're looking for");
            }
            else
            {
                Console.WriteLine($"These aren't the drones your looking for");
            }
        }
